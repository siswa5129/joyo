                ...
                <section class="content">
                    ...
                    <body>
                      	...
                      	<table class="table table-bordered">
                      		...
                      		<tbody>
                            <?php foreach($databarang as $user){ ?>
                      			<tr>
                              <td><?php echo $user['IDberita']; ?></td>
                              <td><?php echo $user['Judul']; ?></td>
                              <td><?php echo $user['Tanggal']; ?></td>
                              <td><?php echo $user['IsiBerita']; ?></td>
                              <td>
                                  <a href="<?php echo base_url()."index.php/Home/hapusArtikel/".$user['IDberita']; ?>">Delete</a>
                              </td>
                      			</tr>
                            <?php } ?>
                      		</tbody>
                      	</table>
                        <a href="<?php echo base_url()."index.php/Home/tambah_Artikel/"; ?>">TAMBAH DATA</a>
                      </body>
        </div><!-- ./wrapper -->
