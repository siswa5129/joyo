...
<html>
    <head>
        <meta charset="UTF-8">
        <title>JOYOPURO dashboard</title>
        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <body>
                        <form align="center" method="POST" action="<?php echo base_url();?>index.php/Home/edituser">
                          ID : <br><input type="text" name="id" value="<?php echo $u_id ?>" readonly="$u_id"><br>
                          USERNAME : <br><input type="text" name="username" value="<?php echo $u_name ?>"><br>
