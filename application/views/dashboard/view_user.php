                    ...
                    <body>
                      	<table class="table table-bordered">
                            ...
                            <?php foreach($databarang as $user){ ?>
                              ...
                              <td>
                                  <a href="<?php echo base_url()."index.php/Home/edit_user/".$user['u_id']; ?>">Edit</a>
                                  <a href="<?php echo base_url()."index.php/Home/hapusUser/".$user['u_id']; ?>">Delete</a>
                              </td>
                      			</tr>
                            <?php } ?>
                      		</tbody>
                      	</table>
                        <a href="<?php echo base_url()."index.php/Home/tambah_User/"; ?>">TAMBAH DATA</a>
                      </body>
        </div><!-- ./wrapper -->
